...
public class PreviousOrderScreen extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        MySQLDatabaseHelper.getAllTransactionsForUser(user_id, getContext(), new MySQLDatabaseHelper.TransactionsCallback() {
            @Override
            public void onTransactionsReceived(List<UserCart> transactions) {
                ...
                try {
                    for(int i =0; i < transactions.size(); i++) {
                        ...
                        title.setText(transactions.get(i).getTimeOrdered());
                        title.setTextSize(30);
                        title.setTextColor(BLACK);
                        //Total formatting
                        TextView priceTotal = new TextView(getContext());
                        priceTotal.setText("$ " + df.format(transactions.get(i).getPrice()));
                        ...
                        try{
                            for(int j = 0; j < transactions.get(i).getUserCart().size(); j++){
                                ...
                                cofName.setText(transactions.get(i).getUserCart().get(j).getName());
                                //Adds the coffee price to the thing
                                TextView cofPrice = new TextView(getContext());
                                cofPrice.setText("$ " + df.format(transactions.get(i).getUserCart().get(j).getPrice()));
                                ...
                                try {
                                    for (int q = 0; q < transactions.get(i).getUserCart().get(j).getFlavorItemList().size(); q++) {
                                        ...
                                        flavorName.setText(transactions.get(i).getUserCart().get(j).getFlavorItemList().get(q).getName());
                                        //Adds the coffee price to the thing
                                        TextView flavorPrice = new TextView(getContext());
                                        flavorPrice.setText("$ " + transactions.get(i).getUserCart().get(j).getFlavorItemList().get(q).getPrice());
                                ...
                                try {
                                    for (int q = 0; q < transactions.get(i).getUserCart().get(j).getToppingItemList().size(); q++) {
                                        ...
                                        topName.setText(transactions.get(i).getUserCart().get(j).getToppingItemList().get(q).getName());
                                        //Adds the coffee price to the thing
                                        TextView topPrice = new TextView(getContext());
                                        topPrice.setText("$ " + df.format(transactions.get(i).getUserCart().get(j).getToppingItemList().get(q).getPrice()));
